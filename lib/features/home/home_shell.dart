...
/// [RidesListScreen] and the new [EventsScreen]. Each tab renders its own
/// `Scaffold` (app bar, FAB, …); this shell only adds the bottom bar around
/// them, so neither tab's own behaviour changes.
///
